type ScenarioAverage.txt

A = zeros(12,89);

A = importdata('ScenarioAverage.txt','-');
[r,c] = size(A);

title('Scenario Average Traffic - normalized UF total');
...
grid on;
export_fig ScenarioAverage_UF.pdf -transparent;
